...
class Emotion(object):
    ...
    def Get_Sentence(self):
        sql = "select id, Content from tencent_comment where over = 'N' limit " + str(100)
        try:
    ...
    def update_db(self, i):
        changeY_sql = "update tencent_comment set over = 'Y' where id = " + str(i)
        try:
    ...
    def Get_Analyse(self):
        ...
        for i in sentence_list:
            try:
                ...
                sql = "update tencent_comment set sentiment = %s, positive_prob = %s, negative_prob = %s, confidence = %s"%(s, p, n, c) + " where id = " + str(i[0])
